...
Three weeks from kickoff to production. Week one — connect Google Business Profile and CRM, calibrate the sentiment classifier against a 50-review sample. Week two — build behavioral segments with the brand's marketing lead, validate against historical churn data. Week three — generate the first retention campaign, ship to production, hand over the dashboard and runbook.
